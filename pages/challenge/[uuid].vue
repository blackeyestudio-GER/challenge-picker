  ...
  <div class="challenge-page">
    <div class="max-w-4xl mx-auto px-4 py-12">
      ...
      <div v-else-if="error" class="challenge-page__error-card border rounded-lg p-8 text-center">
        ...
        <h2 class="challenge-page__error-title text-2xl font-bold mb-2">Challenge Not Found</h2>
      ...
      <div v-else-if="challengeData" class="space-y-6">
        ...
        <div class="text-center mb-8">
          <div class="inline-flex items-center gap-3 mb-4">
            ...
            <h1 class="challenge-page__header-title text-4xl font-bold">You've Been Challenged!</h1>
            <svg class="w-12 h-12 text-yellow-400 animate-pulse" fill="currentColor" viewBox="0 0 20 20">
              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
            </svg>
          </div>
        ...
        <!-- Challenge Card -->
        <div class="challenge-page__card rounded-xl border p-8">
          <div class="flex items-start gap-6">
            ...
            <!-- Details -->
            <div class="flex-1">
              <h2 class="challenge-page__card-title text-3xl font-bold mb-2">{{ challengeData.game.name }}</h2>
              <h3 class="text-xl text-purple-400 mb-4">{{ challengeData.ruleset.name }}</h3>
              
              <div class="grid grid-cols-2 gap-4 mb-4">
                <div class="challenge-page__rule-card rounded-lg p-3">
                  <p class="challenge-page__stat-label text-sm mb-1">Difficulty</p>
                  <p class="challenge-page__stat-value font-semibold">{{ challengeData.ruleset.difficulty }}</p>
                </div>
                <div class="challenge-page__rule-card rounded-lg p-3">
                  <p class="challenge-page__stat-label text-sm mb-1">Max Active Rules</p>
                  <p class="challenge-page__stat-value font-semibold">{{ challengeData.maxConcurrentRules }}</p>
                </div>
              </div>

              <p class="challenge-page__header-subtitle text-sm">
        ...
        <div v-else class="text-center">
          ...
          <p v-if="hasActivePlaythrough" class="challenge-page__stat-label text-sm mt-3">
            Complete or stop your current playthrough first
          </p>

          <div v-if="acceptError" class="mt-4 p-4 challenge-page__error-card border rounded-lg">
