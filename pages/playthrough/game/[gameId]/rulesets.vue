...
const { fetchGames, fetchRulesets, games, rulesets, loading, error } = usePlaythrough()
...
<template>
  <div class="playthrough-rulesets-page">
    ...
    <template v-else>
      <div v-if="rulesets.length > 0" class="playthrough-rulesets-page__rulesets-container">
