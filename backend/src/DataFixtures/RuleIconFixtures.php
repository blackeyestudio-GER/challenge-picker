...
class RuleIconFixtures extends Fixture implements DependentFixtureInterface
{
    ...
    public function load(ObjectManager $manager): void
    {
        ...
        foreach ($icons as $iconData) {
            $icon = new RuleIcon();
            $icon->setIdentifier(ArrayTypeHelper::getString($iconData, 'identifier'));
            ...
            $icon->setLicense(ArrayTypeHelper::tryGetString($iconData, 'license') ?? 'CC BY 3.0');
            $icon->setSource(ArrayTypeHelper::tryGetString($iconData, 'source') ?? 'game-icons.net');

            $manager->persist($icon);

            // Create reference for linking to rules
            $identifier = ArrayTypeHelper::getString($iconData, 'identifier');
            $this->addReference('icon_' . $identifier, $icon);
        }
    ...
    private function getIconsData(): array
    {
        return [
            ...
            [
                ...
                'category' => 'weapon',
                'displayName' => 'Dagger',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M62.5 17.28c-9.747.288-20.824 5.23-29.844 14.25-15.192 15.193-18.838 36.194-8.125 46.907 7.99 7.988 21.716 8.027 34.47 1.22 16.167 30.05 42.154 57.687 71.438 76.374-18.77 24.156-29.97 54.48-29.97 87.376h18.688c0-28.9 9.828-55.474 26.344-76.53l2.156 39.405C274.5 320.554 402.09 428.196 496.062 494.94c-65.54-95.294-176.99-224.638-288.687-348.407l-38.97-2.124c20.764-15.68 46.638-24.967 74.72-24.97V100.75c-32.2.002-61.945 10.725-85.844 28.78-18.696-29.383-46.39-55.48-76.53-71.686 6.795-12.748 6.796-26.423-1.188-34.407-4.352-4.352-10.393-6.352-17.062-6.156z"/></svg>',
                'tags' =>  [
                    0 => 'melee',
                    1 => 'blade',
                    2 => 'weapon',
            ...
            [
                'identifier' => 'pistol-gun',
                'category' => 'weapon',
                'displayName' => 'Pistol',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M79.238 115.768l-28.51 67.863h406.15l-.273-67.862h-263.83v55.605h-15v-55.605h-16.68v55.605H146.1v-55.605h-17.434v55.605h-15v-55.605H79.238zm387.834 15.96v40.66h18.688v-40.66h-18.688zM56.768 198.63l20.566 32.015L28.894 406.5l101.68 7.174 21.54-97.996h115.74l14.664-80.252 174.55-3.873-.13-32.922H56.767zM263.44 235.85l-11.17 61.142h-96.05l12.98-59.05 12.53-.278-2.224 35.5 14.262 13.576 1.003-33.65 24.69-16.264 43.98-.976z"/></svg>',
                'tags' =>  [
                    0 => 'firearm',
                    1 => 'ranged',
                    2 => 'weapon',
            ...
            [
                ...
                'category' => 'weapon',
                'displayName' => 'Thrust',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M452.798 479.462L59.205 481.31s154.378-369.683 151.153-379.303l-46.12-.224 93.677-71.09 95.207 72.397-50.263.224z"/></svg>',
                'tags' =>  [
                    0 => 'melee',
                    1 => 'weapon',
                ],
            ...
            [
                ...
                'category' => 'movement',
                'displayName' => 'Dodge',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M465.074 481.646c-24.928 1.186-334.495-.667-334.495-.667-188.07-188.857 283.16-251.37-8.1-406.484l-20.382 21.487-27.14-71.216 87.582 6.818-17.534 19.7c364.276 106.15-48.98 305.105 320.068 430.36z"/></svg>',
                'tags' =>  [
                    0 => 'movement',
                    1 => 'action',
                    2 => 'defense',
            ...
            [
                ...
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M130.81 21.785v245.95H43.84L256 489.382l212.158-221.644H381.19V21.786h-39.118v301.028c.263 2.756.403 5.547.403 8.37 0 48.275-39.334 87.61-87.61 87.61-46.467 0-84.644-36.446-87.44-82.228h-.288V21.786zm127.018 8.485L230.33 261.984 212.82 133.98c-3.592 63.362-25.266 134.536-25.365 196.592 0 37.12 30.29 67.408 67.408 67.408 37.117 0 67.408-30.288 67.408-67.408 0-1.938-.1-3.854-.262-5.752-6.334-49.764-13.546-100.753-20.408-150.924l-13.422 98.135c-.587-.335-1.176-.667-1.774-.985zm-2.965 251.572c27.027 0 48.73 21.703 48.73 48.73 0 27.026-21.707 48.733-48.73 48.733-27.027 0-48.73-21.706-48.73-48.733 0-27.026 21.708-48.73 48.73-48.73z"/></svg>',
                'tags' =>  [
                    0 => 'movement',
                    1 => 'damage',
                ],
            ...
            [
                'identifier' => 'health-normal',
                'category' => 'resource',
                'displayName' => 'Health',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M196 16a30 30 0 0 0-30 30v120H46a30 30 0 0 0-30 30v120a30 30 0 0 0 30 30h120v120a30 30 0 0 0 30 30h120a30 30 0 0 0 30-30V346h120a30 30 0 0 0 30-30V196a30 30 0 0 0-30-30H346V46a30 30 0 0 0-30-30H196z"/></svg>',
                'tags' =>  [
                    0 => 'resource',
                    1 => 'health',
                ],
            ...
            [
                'identifier' => 'heart-plus',
                'category' => 'resource',
                'displayName' => 'Extra Health',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M372.48 31.215c-77.65 0-116.48 65.73-116.48 65.73s-38.83-65.72-116.48-65.72c-37.14 0-107.77 33.72-107.77 125.13 0 161.24 224.25 324.43 224.25 324.43s224.25-163.19 224.25-324.43c0-91.42-70.63-125.13-107.77-125.14zm-145.492 115.02h60.698v79.415h79.238v60.7h-79.238v79.884h-60.698V286.35h-80.064v-60.7h80.064z"/></svg>',
                'tags' =>  [
                    0 => 'resource',
                    1 => 'health',
                ],
            ...
            [
                ...
                'category' => 'resource',
                'displayName' => 'Hearts',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M480.25 156.355c0 161.24-224.25 324.43-224.25 324.43S31.75 317.595 31.75 156.355c0-91.41 70.63-125.13 107.77-125.13 77.65 0 116.48 65.72 116.48 65.72s38.83-65.73 116.48-65.73c37.14.01 107.77 33.72 107.77 125.14z"/></svg>',
                'tags' =>  [
                    0 => 'resource',
                    1 => 'health',
                ],
            ...
            [
                ...
                'color' => '#FFFFFF',
                'license' => 'CC BY 3.0',
                'source' => 'game-icons.net (artist: priorblue)',
            ],
            [
                'identifier' => 'battery-75',
                'category' => 'resource',
                'displayName' => 'Battery 75%',
            ...
            [
                'identifier' => 'battery-100',
                'category' => 'resource',
                'displayName' => 'Full Battery',
            ...
            [
                'identifier' => 'armor-upgrade',
                'category' => 'resource',
                'displayName' => 'Armor Upgrade',
            ...
            [
                ...
                'category' => 'resource',
                'displayName' => 'Diamond',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"><path fill="currentColor" d="M128 48l-64 80 64 80 64-80z"/></svg>',
                'tags' =>  [
                    0 => 'resource',
                    1 => 'currency',
                ],
                'color' => '#FFFFFF',
                'license' => 'CC BY 3.0',
                'source' => 'game-icons.net (artist: badges)',
            ],
            [
                'identifier' => 'money-stack',
                'category' => 'resource',
                'displayName' => 'Money Stack',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M327.027 65.816L229.79 128.23l9.856 5.397 86.51-55.53 146.735 83.116-84.165 54.023 4.1 2.244v6.848l65.923-42.316 13.836 7.838-79.76 51.195v11.723l64.633-41.487 15.127 8.57-79.76 51.195v11.723l64.633-41.487 15.127 8.57-79.76 51.195v11.723l100.033-64.21-24.828-14.062 24.827-15.937-24.828-14.064 24.827-15.937-23.537-13.333 23.842-15.305-166.135-94.106zm31.067 44.74c-21.038 10.556-49.06 12.342-68.79 4.383l-38.57 24.757 126.903 69.47 36.582-23.48c-14.41-11.376-13.21-28.35 2.942-41.67l-59.068-33.46zM227.504 147.5l-70.688 46.094 135.61 78.066 1.33-.85c2.5-1.61 6.03-3.89 10.242-6.613 8.42-5.443 19.563-12.66 30.674-19.86 16.002-10.37 24.248-15.72 31.916-20.694L227.504 147.5zm115.467 1.17a8.583 14.437 82.068 0 1 .003 0 8.583 14.437 82.068 0 1 8.32 1.945 8.583 14.437 82.068 0 1-.87 12.282 8.583 14.437 82.068 0 1-20.273 1.29 8.583 14.437 82.068 0 1 .87-12.28 8.583 14.437 82.068 0 1 11.95-3.237zm-218.423 47.115L19.143 263.44l23.537 13.333-23.842 15.305 24.828 14.063-24.828 15.938 24.828 14.063-24.828 15.938 166.135 94.106L285.277 381.8V370.08l-99.433 63.824L39.11 350.787l14.255-9.15 131.608 74.547L285.277 351.8V340.08l-99.433 63.824L39.11 320.787l14.255-9.15 131.608 74.547L285.277 321.8V310.08l-99.433 63.824L39.11 290.787l13.27-8.52 132.9 75.28 99.997-64.188v-5.05l-5.48-3.154-93.65 60.11-146.73-83.116 94.76-60.824-9.63-5.543zm20.46 11.78l-46.92 30.115c14.41 11.374 13.21 28.348-2.942 41.67l59.068 33.46c21.037-10.557 49.057-12.342 68.787-4.384l45.965-29.504-123.96-71.358zm229.817 32.19c-8.044 5.217-15.138 9.822-30.363 19.688-11.112 7.203-22.258 14.42-30.69 19.873-4.217 2.725-7.755 5.01-10.278 6.632-.09.06-.127.08-.215.137v85.924l71.547-48.088v-84.166zm-200.99 17.48a8.583 14.437 82.068 0 1 8.32 1.947 8.583 14.437 82.068 0 1-.87 12.28 8.583 14.437 82.068 0 1-20.27 1.29 8.583 14.437 82.068 0 1 .87-12.28 8.583 14.437 82.068 0 1 11.95-3.236z"/></svg>',
                'tags' =>  [
                    0 => 'resource',
                    1 => 'currency',
                ],
            ...
            [
                ...
                'category' => 'modifier',
                'displayName' => 'Padlock',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M254.28 17.313c-81.048 0-146.624 65.484-146.624 146.406V236h49.594v-69.094c0-53.658 43.47-97.187 97.03-97.187 53.563 0 97.032 44.744 97.032 97.186V236h49.594v-72.28c0-78.856-65.717-146.407-146.625-146.407zM85.157 254.688c-14.61 22.827-22.844 49.148-22.844 76.78 0 88.358 84.97 161.5 191.97 161.5 106.998 0 191.968-73.142 191.968-161.5 0-27.635-8.26-53.95-22.875-76.78H85.155zM254 278.625c22.34 0 40.875 17.94 40.875 40.28 0 16.756-10.6 31.23-25.125 37.376l32.72 98.126h-96.376l32.125-98.125c-14.526-6.145-24.532-20.62-24.532-37.374 0-22.338 17.972-40.28 40.312-40.28z"/></svg>',
                'tags' =>  [
                    0 => 'modifier',
                    1 => 'restriction',
                ],
            ...
            [
                'identifier' => 'save-arrow',
                'category' => 'modifier',
                'displayName' => 'Save Arrow',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M224 30v256h-64l96 128 96-128h-64V30h-64zM32 434v48h448v-48H32z"/></svg>',
                'tags' =>  [
                    0 => 'modifier',
                    1 => 'action',
                ],
            ...
            [
                'identifier' => 'chat-bubble',
                'category' => 'modifier',
                'displayName' => 'Chat Bubble',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M229.7 22.66A155.2 235.6 80.24 0 0 23.81 215.6 155.2 235.6 80.24 0 0 236.7 333.4c23.8 55.6-17.1 109.3-83.6 161.1 86.2-28.3 176.2-94.4 179.7-178.7a155.2 235.6 80.24 0 0 155.4-180.1A155.2 235.6 80.24 0 0 229.7 22.66z"/></svg>',
                'tags' =>  [
                    0 => 'modifier',
                    1 => 'action',
                ],
            ...
            [
                ...
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"><path fill="currentColor" d="M84.18 168.7H113V86.99l-29.58 6.1V70.91l29.38-6.09h31V168.7h28.8v22.5H84.18z"/></svg>',
                'tags' =>  [
                    0 => 'modifier',
                    1 => 'count',
                ],
            ...
            [
                ...
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"><path fill="currentColor" d="M118.3 168.3h55.6v24H82.08v-24l46.12-40.7q6.2-5.5 9.1-10.9 3-5.3 3-11.1 0-8.85-6-14.27-5.9-5.42-15.8-5.42-7.6 0-16.7 3.3-9.06 3.22-19.38 9.65V71.1q11-3.64 21.78-5.5 10.7-1.95 21-1.95 22.7 0 35.3 9.99 12.6 9.99 12.6 27.86 0 10.3-5.4 19.3-5.3 8.9-22.4 23.9z"/></svg>',
                'tags' =>  [
                    0 => 'modifier',
                    1 => 'count',
                ],
            ...
            [
                ...
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"><path fill="currentColor" d="M149.5 123q12.8 3.3 19.4 11.5 6.7 8.1 6.7 20.7 0 18.8-14.4 28.6t-42 9.8q-9.7 0-19.51-1.7-9.73-1.5-19.29-4.6v-25.1q9.14 4.5 18.11 6.9 9.09 2.3 17.79 2.3 12.9 0 19.8-4.5T143 154q0-8.6-7.1-13-7-4.5-20.8-4.5h-13v-21h13.7q12.2 0 18.3-3.8 6-3.9 6-11.75 0-7.28-5.9-11.26-5.8-3.98-16.5-3.98-7.9 0-15.9 1.78-8.03 1.78-15.99 5.25V67.87q9.65-2.71 19.09-4.06 9.5-1.36 18.7-1.36 24.6 0 36.8 8.13 12.2 8.04 12.2 24.29 0 11.13-5.8 18.23-5.8 7-17.3 9.9z"/></svg>',
                'tags' =>  [
                    0 => 'modifier',
                    1 => 'count',
                ],
            ...
            [
                ...
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"><path fill="currentColor" d="M131.6 91.67L95.88 144.6h35.72zm-5.4-26.83h36.2v79.76h18v23.6h-18v23h-30.8v-23H75.57v-28z"/></svg>',
                'tags' =>  [
                    0 => 'modifier',
                    1 => 'count',
                ],
            ...
            [
                ...
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256"><path fill="currentColor" d="M85.43 63.64h80.97v23.95h-55v19.51q3.7-1 7.5-1.5 3.8-.6 7.8-.6 23.1 0 36 11.6 12.9 11.5 12.9 32.2 0 20.5-14.1 32.1-14 11.6-38.8 11.6-10.8 0-21.4-2.2-10.46-2-20.87-6.2v-25.7q10.33 6 19.55 8.9 9.32 3 17.52 3 11.9 0 18.6-5.8 6.9-5.8 6.9-15.7 0-10-6.9-15.8-6.7-5.7-18.6-5.7-7 0-15 1.8-7.93 1.8-17.07 5.6z"/></svg>',
                'tags' =>  [
                    0 => 'modifier',
                    1 => 'count',
                ],
            ...
            [
                'identifier' => 'round-star',
                'category' => 'ability',
                'displayName' => 'Ultimate Ability',
            ...
            [
                'identifier' => 'allied-star',
                'category' => 'ability',
                'displayName' => 'Allied Star',
            ...
            [
                ...
                'category' => 'combat',
                'displayName' => 'Combat',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M19.75 14.438c59.538 112.29 142.51 202.35 232.28 292.718l3.626 3.75.063-.062c21.827 21.93 44.04 43.923 66.405 66.25-18.856 14.813-38.974 28.2-59.938 40.312l28.532 28.53 68.717-68.717c42.337 27.636 76.286 63.646 104.094 105.81l28.064-28.06c-42.47-27.493-79.74-60.206-106.03-103.876l68.936-68.938-28.53-28.53c-11.115 21.853-24.413 42.015-39.47 60.593-43.852-43.8-86.462-85.842-130.125-125.47-.224-.203-.432-.422-.656-.625C183.624 122.75 108.515 63.91 19.75 14.437zm471.875 0c-83.038 46.28-154.122 100.78-221.97 161.156l22.814 21.562 56.81-56.812 13.22 13.187-56.438 56.44 24.594 23.186c61.802-66.92 117.6-136.92 160.97-218.72zm-329.53 125.906l200.56 200.53c-4.36 4.443-8.84 8.793-13.405 13.032L148.875 153.53l13.22-13.186zm-76.69 113.28l-28.5 28.532 68.907 68.906c-26.29 43.673-63.53 76.414-106 103.907l28.063 28.06c27.807-42.164 61.758-78.174 104.094-105.81l68.718 68.717 28.53-28.53c-20.962-12.113-41.08-25.5-59.937-40.313 17.865-17.83 35.61-35.433 53.157-52.97l-24.843-25.655-55.47 55.467c-4.565-4.238-9.014-8.62-13.374-13.062l55.844-55.844-24.53-25.374c-18.28 17.856-36.602 36.06-55.158 54.594-15.068-18.587-28.38-38.758-39.5-60.625z"/></svg>',
                'tags' =>  [
                    0 => 'combat',
                ],
                'color' => '#FFFFFF',
            ...
            [
                'identifier' => 'kick-scooter',
                'category' => 'combat',
                'displayName' => 'Kick Scooter',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M306.9 40v18h72.4l43.9 263.9L350.3 424h-203c-2.7-24-16.2-46.5-36.8-59.8-23.17-15-55.72-17.3-88.39 3.2l9.58 15.2c27.83-17.5 51.27-14.8 69.01-3.3 15.1 9.8 25.7 26.9 28.5 44.7h-24.3c-4.1-17.2-19.46-30-38-30-21.65 0-39 17.4-39 39s17.35 39 39 39c18.54 0 33.9-12.8 38-30h254.6l67.9-95.1 8.4 50.1c-14.1 5.9-23.9 19.8-23.9 36 0 21.6 17.4 39 39 39s39-17.4 39-39c0-20.7-16-37.5-36.3-38.9L397.5 58h21.4V40z"/></svg>',
                'tags' =>  [
                    0 => 'combat',
                    1 => 'melee',
                ],
            ...
            [
                'identifier' => 'claw-slashes',
                'category' => 'combat',
                'displayName' => 'Claw Slashes',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M182.338 22.55c152.455 20.22 254.7 176.264 228.928 258.163-34.76-89.215-143.516-189.588-300.207-196.15C255.855 103.772 355.365 245.5 342.92 329.856c-9.85.97-20.79.927-32.852-.24-41.436-84.32-146.004-172.382-292.437-178.513 142.546 18.907 241.2 156.557 232.36 241.316-15.664-.633-33.447-3.34-53.48-8.46 18.37 8.188 35.514 14.817 51.502 20.067-10.614 44.085-55.285 69.374-144.93 46.47C250 515.968 319.647 483.338 328.736 419.743c56.24 1.254 85.915-24.86 92.856-63.008 164.112-19.88 36.806-322.627-239.254-334.185zm132.808 318.083c7.97 2.704 15.666 5.077 23.07 7.11-3.122 7.893-7.546 14.993-13.35 21.095-2.393-9.222-5.635-18.663-9.72-28.205z"/></svg>',
                'tags' =>  [
                    0 => 'combat',
                    1 => 'melee',
                ],
            ...
            [
                ...
                'category' => 'strategy',
                'displayName' => 'Castle',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M255.95 27.11L180.6 107.614l150.7 1.168-75.35-81.674h-.003zM25 109.895v68.01l19.412 25.99h71.06l19.528-26v-68h-14v15.995h-18v-15.994H89v15.995H71v-15.994H57v15.995H39v-15.994H25zm352 0v68l19.527 26h71.06L487 177.906v-68.01h-14v15.995h-18v-15.994h-14v15.995h-18v-15.994h-14v15.995h-18v-15.994h-14zm-176 15.877V260.89h110V126.63l-110-.857zm55 20.118c8 0 16 4 16 12v32h-32v-32c0-8 8-12 16-12zM41 221.897V484.89h78V221.897H41zm352 0V484.89h78V221.897h-78zM56 241.89c4 0 8 4 8 12v32H48v-32c0-8 4-12 8-12zm400 0c4 0 8 4 8 12v32h-16v-32c0-8 4-12 8-12zm-303 37v23h-16v183h87v-55c0-24 16-36 32-36s32 12 32 36v55h87v-183h-16v-23h-14v23h-18v-23h-14v23h-18v-23h-14v23h-18v-23h-14v23h-18v-23h-14v23h-18v-23h-14v23h-18v-23h-14zm-49 43c4 0 8 4 8 12v32H96v-32c0-8 4-12 8-12zm72 0c8 0 16 4 16 12v32h-32v-32c0-8 8-12 16-12zm80 0c8 0 16 4 16 12v32h-32v-32c0-8 8-12 16-12zm80 0c8 0 16 4 16 12v32h-32v-32c0-8 8-12 16-12zm72 0c4 0 8 4 8 12v32h-16v-32c0-8 4-12 8-12zm-352 64c4 0 8 4 8 12v32H48v-32c0-8 4-12 8-12zm400 0c4 0 8 4 8 12v32h-16v-32c0-8 4-12 8-12z"/></svg>',
                'tags' =>  [
                    0 => 'strategy',
                    1 => 'building',
                ],
            ...
            [
                ...
                'category' => 'strategy',
                'displayName' => 'Upgrade',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M256 29.816l-231 154v106.368l231-154 231 154V183.816zm0 128.043L105 259.783v90.283l151-101.925 151 101.925v-90.283zm0 112l-87 58.725v67.6l87-58 87 58v-67.6zm0 89.957l-87 58v64.368l87-58 87 58v-64.368z"/></svg>',
                'tags' =>  [
                    0 => 'strategy',
                    1 => 'progression',
                ],
            ...
            [
                'identifier' => 'chess-pawn',
                'category' => 'strategy',
                'displayName' => 'Unit',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M312.07 194.46A56.07 56.07 0 1 1 256 138.39a56.07 56.07 0 0 1 56.07 56.07zM406 418.01H106v60h300v-60zM282.33 261.52a71.81 71.81 0 0 1-52.15.2c-.73 58.91-62.35 114.06-96.75 140.28H378.9c-34.09-26.33-95.44-81.78-96.57-140.48z"/></svg>',
                'tags' =>  [
                    0 => 'strategy',
                    1 => 'unit',
                ],
            ...
            [
                'identifier' => 'barracks-tent',
                'category' => 'strategy',
                'displayName' => 'Barracks Tent',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M247 28v80h18V28zm35 0v64l80-32zm-26 96c-48 48-144 112-192 128 0 64-16 208-32 240h160c16-16 64-144 64-192 0 48 48 176 64 192h160c-16-32-32-176-32-240-48-16-144-80-192-128zM112 300h80v80h-80z"/></svg>',
                'tags' =>  [
                    0 => 'strategy',
                    1 => 'building',
                ],
            ...
            [
                'identifier' => 'chess-knight',
                'category' => 'strategy',
                'displayName' => 'Chess Knight',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M60.81 476.91h300v-60h-300v60zm233.79-347.3l13.94 7.39c31.88-43.62 61.34-31.85 61.34-31.85l-21.62 53 35.64 19 2.87 33 64.42 108.75-43.55 29.37s-26.82-36.39-39.65-43.66c-10.66-6-41.22-10.25-56.17-12l-67.54-76.91-12 10.56 37.15 42.31c-.13.18-.25.37-.38.57-35.78 58.17 23 105.69 68.49 131.78H84.14C93 85 294.6 129.61 294.6 129.61z"/></svg>',
                'tags' =>  [
                    0 => 'strategy',
                    1 => 'unit',
                ],
            ...
            [
                'identifier' => 'chess-rook',
                'category' => 'strategy',
                'displayName' => 'Chess Rook',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M406 484.7H106v-60h300v60zm-56.67-330.83h-50.05V91.3h-82.39v62.57h-54.22V91.3h-54.23v113.67h295.12V91.3h-54.23v62.57zm23.35 67.23H139.32v187.6h233.36V221.1z"/></svg>',
                'tags' =>  [
                    0 => 'strategy',
                    1 => 'unit',
                ],
            ...
            [
                'identifier' => 'chess-bishop',
                'category' => 'strategy',
                'displayName' => 'Chess Bishop',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M406.02 476.915h-300v-60h300v60zm-83.46-181H189.48v17.65h133.08v-17.65zm11.78-77.69a200 200 0 0 1-9.39 61.69H187.09a200 200 0 0 1-9.39-61.69c0-59.09 23.82-109 56.41-124.67a33.34 33.34 0 1 1 43.82 0c32.59 15.71 56.41 65.58 56.41 124.67zm-51.07-48.91h-19.25v-23.92h-16v23.92h-19.26v16h19.26v51.54h16v-51.54h19.25v-16zm38.15 180.69v-20.44h-130.8v20.44H93.29v.11l49.46 49.46h82.08l31.15-36 31.15 36h82.44l48.87-48.87.27-.69h-97.29z"/></svg>',
                'tags' =>  [
                    0 => 'strategy',
                    1 => 'unit',
                ],
            ...
            [
                'identifier' => 'water-drop',
                'category' => 'survival',
                'displayName' => 'Water',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M406.043 316c24.11 96.443-50.59 180-150 180s-174.405-82.38-150-180c15-60 90-150 150-300 60 150 135 240 150 300z"/></svg>',
                'tags' =>  [
                    0 => 'survival',
                    1 => 'resource',
                ],
            ...
            [
                ...
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M253.75 18.906c-77.635.03-154.875 54.01-154.875 167.5v209.72c25.67 19.717 46.68 41.386 52.156 69.124-3.507-44.464-4.166-88.692 14.595-133.156 5.265 38.52 8.087 77.137 26.875 115.656 25.316-53.302 59.948-75.555 102.188-72.438-29.706 25.94-56.26 55.26-74.75 95.22 31.477-30.2 66.886-38.728 103.968-40.907-21.57 15.247-41.576 30.414-54.156 50.22h78.344c6.443-27.99-4.756-54.648-17.78-82.908 27.59 18.168 51.09 40.4 61.905 77.657 3.525-39-3.843-73.686-15.19-106.875 13.34 6.44 23.875 15.568 31.595 27.374V186.406c0-113.616-77.24-167.528-154.875-167.5zM150.156 144.594h114.938v18.687H150.156v-18.686zm152.438 0h56.125v18.687h-56.126v-18.686zm-152.438 42.75h36.5v18.687h-36.5v-18.686zm72.25 0H358.72v18.687H222.405v-18.686zm-72.28 40.312h95.81v18.688h-95.81v-18.688zm126.31 0h82.283v18.688h-82.283v-18.688zm-177.56 189.53v62.658h23.686c-4.638-21.58-13.086-42.375-23.687-62.656z"/></svg>',
                'tags' =>  [
                    0 => 'horror',
                    1 => 'atmosphere',
                ],
            ...
            // ===== OTHER =====
            [
                'identifier' => '3d-glasses',
                'category' => 'other',
                'displayName' => '3d Glasses',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M176 80L39.36 247h77.74L176 144l32 48v-48l-32-64zm160 0l-32 64v48l32-48 58.9 103h77.7L336 80zM25 265v174h194.2l36.8-55.2 36.8 55.2H487V265H25zm23 23h176v64l-32 64H48V288zm240 0h176v128H320l-32-64v-64z"/></svg>',
                'tags' =>  [
                    0 => 'other',
                ],
                'color' => '#FFFFFF',
            ...
            [
                'identifier' => 'abbot-meeple',
                'category' => 'other',
                'displayName' => 'Abbot Meeple',
            ...
            [
                'identifier' => 'abstract-003',
                'category' => 'other',
                'displayName' => 'Abstract 003',
            ...
            [
                'identifier' => 'abstract-005',
                'category' => 'other',
                'displayName' => 'Abstract 005',
            ...
            [
                'identifier' => 'abstract-007',
                'category' => 'other',
                'displayName' => 'Abstract 007',
            ...
            [
                'identifier' => 'abstract-011',
                'category' => 'other',
                'displayName' => 'Abstract 011',
            ...
            [
                'identifier' => 'abstract-013',
                'category' => 'other',
                'displayName' => 'Abstract 013',
            ...
            [
                'identifier' => 'abstract-019',
                'category' => 'other',
                'displayName' => 'Abstract 019',
            ...
            [
                'identifier' => 'abstract-021',
                'category' => 'other',
                'displayName' => 'Abstract 021',
            ...
            [
                'identifier' => 'abstract-027',
                'category' => 'other',
                'displayName' => 'Abstract 027',
            ...
            [
                'identifier' => 'abstract-037',
                'category' => 'other',
                'displayName' => 'Abstract 037',
            ...
            [
                'identifier' => 'abstract-039',
                'category' => 'other',
                'displayName' => 'Abstract 039',
            ...
            [
                'identifier' => 'abstract-042',
                'category' => 'other',
                'displayName' => 'Abstract 042',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="m21,21v120.7313 103.8407h111.1844 68.2971v20.8562h-68.2971-111.1844v103.8409 120.7308h111.1844v-120.7308h68.2971 111.0376 68.2967v120.7308h111.1842v-120.7308-103.8409h-111.1842-68.2967v-20.8562h68.2967 111.1842v-103.8407-120.7313h-111.1842v120.7313h-68.2967-111.0376-68.2971v-120.7313h-111.1844zm139.2373,0v90.0344h191.3785v-90.0344h-191.3785zm0,379.9658v90.0342h191.3785v-90.0342h-191.3785z"/></svg>',
                'tags' =>  [
                    0 => 'other',
                ],
                'color' => '#FFFFFF',
            ...
            [
                'identifier' => 'abstract-044',
                'category' => 'other',
                'displayName' => 'Abstract 044',
            ...
            [
                'identifier' => 'abstract-045',
                'category' => 'other',
                'displayName' => 'Abstract 045',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="m126.6029,21c-58.5338,0-105.6029,47.0641-105.6029,105.6031v258.7938c0,58.539 47.0691,105.6031 105.6029,105.6031h45.3846v-54.3438h37.4529v54.3438h27.4658v-54.3438h38.1875v54.3438h27.4659v-54.3438h37.7467v54.3438h45.0909c58.5338,0 105.6029-47.0641 105.6029-105.6031v-258.7938c0-58.539-47.0691-105.6031-105.6029-105.6031h-45.0909v54.7844h-37.7467v-54.7844h-27.4659v54.7844h-38.1875v-54.7844h-27.4658v54.7844h-37.4529v-54.7844h-45.3846zm129.3972,76.9625c87.2954,0 158.1846,70.7428 158.1846,158.0375s-70.8892,158.1843-158.1846,158.1843-158.1846-70.8897-158.1846-158.1843 70.8891-158.0375 158.1846-158.0375zm0,28.9343c-64.7322,0-118.2901,47.5947-127.6346,109.7157h255.2692c-9.3446-62.121-62.9025-109.7157-127.6346-109.7157zm-127.6346,148.4906c9.3445,62.1433 62.9025,109.8625 127.6346,109.8625s118.29-47.7192 127.6346-109.8625h-255.2692z"/></svg>',
                'tags' =>  [
                    0 => 'other',
                ],
                'color' => '#FFFFFF',
            ...
            [
                'identifier' => 'abstract-050',
                'category' => 'other',
                'displayName' => 'Abstract 050',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="m21,21v135.125h135.125v-135.125h-135.125zm167.4375,0v135.125h135.125v-135.125h-135.125zm167.4375,0v135.125h135.125v-135.125h-135.125zm-334.875,167.4375v135.125h135.125v-135.125h-135.125zm167.4375,0v135.125h135.125v-135.125h-135.125zm167.4375,0v135.125h135.125v-135.125h-135.125zm-334.875,167.4375v135.125h135.125v-135.125h-135.125zm167.4375,0v135.125h135.125v-135.125h-135.125zm167.4375,0v135.125h135.125v-135.125h-135.125z"/></svg>',
                'tags' =>  [
                    0 => 'other',
                ],
                'color' => '#FFFFFF',
            ...
            [
                'identifier' => 'abstract-058',
                'category' => 'other',
                'displayName' => 'Abstract 058',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="m21,21v228.5688h168.1719v115.5594h-21.0031v-94.1469h-147.1688v220.0188h470v-220.0188h-147.1687v94.1469h-21.0032v-115.5594h168.1719v-228.5688h-35.1031v145.1125h-108.8344v-145.1125h-36.5719v145.1125h-108.8343v-145.1125h-36.7188v145.1125h-108.8344v-145.1125z"/></svg>',
                'tags' =>  [
                    0 => 'other',
                ],
                'color' => '#FFFFFF',
            ...
            [
                'identifier' => 'abstract-064',
                'category' => 'other',
                'displayName' => 'Abstract 064',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="m339.9975,29.9471c-74.4602-24.1534-168.9843.9596-238.9555,70.9308s-95.278,164.6891-71.1246,239.1493c9.5782-66.1157 47.1447-139.5873 108.9157-201.3582s135.0488-99.1436 201.1645-108.7218zm142.0554,142.0554c-9.5782,66.1157-47.0477,139.2965-108.8187,201.0675s-135.1456,99.4343-201.2614,109.0126c74.4602,24.1534 169.1782-1.1536 239.1493-71.1247s95.0843-164.4953 70.9308-238.9554zm-92.1519-49.9035c-50.4068-50.4068-151.2436-31.3161-225.1957,42.6359s-93.0428,174.7889-42.636,225.1957 151.2437,31.3161 225.1957-42.6359 93.0427-174.7889 42.636-225.1957zm-74.0316,24.6126c.6904.5636 1.2938,1.2938 1.938,1.938l45.543,45.543c10.3068,10.3069 10.3068,26.9029 0,37.2096s-26.9028,10.3068-37.2096,0l-45.543-45.543c-10.3068-10.3069-10.3068-26.9028 0-37.2096 9.6627-9.6627 24.9181-10.3929 35.2717-1.938zm-75.6789,56.4927c.6904.5636 1.1969,1.197 1.8411,1.8411l64.923,64.9231c10.3069,10.3068 10.3069,26.9028 0,37.2095s-26.9027,10.307-37.2096,0l-64.923-64.923c-10.3068-10.3068-10.3068-26.9027 0-37.2096 9.6626-9.6626 25.0149-10.2959 35.3685-1.8411zm-56.3959,75.5821c.6904.5636 1.2938,1.2938 1.938,1.9379l45.543,45.543c10.3068,10.3068 10.3068,26.9028 0,37.2096s-26.9028,10.3068-37.2096,0l-45.543-45.543c-10.3068-10.3068-10.3068-26.9028 0-37.2096 9.6626-9.6626 24.918-10.3929 35.2716-1.9379z"/></svg>',
                'tags' =>  [
                    0 => 'other',
                ],
                'color' => '#FFFFFF',
            ...
            [
                'identifier' => 'abstract-076',
                'category' => 'other',
                'displayName' => 'Abstract 076',
            ...
            [
                'identifier' => 'abstract-086',
                'category' => 'other',
                'displayName' => 'Abstract 086',
            ...
            [
                'identifier' => 'abstract-087',
                'category' => 'other',
                'displayName' => 'Abstract 087',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="m21,21v71.6751h71.675v-71.6751h-71.675zm104.575,0v71.6751h260.85v-71.6751h-260.85zm293.75,0v71.6751h71.675v-71.6751h-71.675zm-398.325,104.575v260.85h71.675v-260.85h-71.675zm104.575,0v260.85h31.8719c2.6667-45.8772 36.6737-83.2489 80.9281-91.2094v-78.4313c-44.2544-7.9605-78.2614-45.3321-80.9281-91.2094h-31.8719zm228.9781,0c-2.6667,45.8773-36.6738,83.2489-80.9281,91.2094v78.4313c44.2543,7.9605 78.2614,45.3321 80.9281,91.2094h31.8719v-260.85h-31.8719zm64.7719,0v260.85h71.675v-260.85h-71.675zm-398.325,293.75v71.675h71.675v-71.675h-71.675zm104.575,0v71.675h260.85v-71.675h-260.85zm293.75,0v71.675h71.675v-71.675h-71.675z"/></svg>',
                'tags' =>  [
                    0 => 'other',
                ],
                'color' => '#FFFFFF',
            ...
            [
                'identifier' => 'abstract-098',
                'category' => 'other',
                'displayName' => 'Abstract 098',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="m115.0001,21.0001v94h-94.0001v94h94.0001v94h-94.0001v94h94.0001v94h94v-94h94v94h93.9999v-94h94v-94h-94v-94h94v-94h-94v-94h-93.9999v94h-94v-94h-94zm141,148.9312c47.548,0 86.0687,38.5208 86.0687,86.0687s-38.5207,86.0687-86.0687,86.0687-86.0688-38.5208-86.0688-86.0687 38.5208-86.0687 86.0688-86.0687zm0,29.9625c-30.9781,0-56.1063,25.128-56.1063,56.1063s25.1281,56.1062 56.1063,56.1062 56.1062-25.128 56.1062-56.1062-25.1281-56.1063-56.1062-56.1063z"/></svg>',
                'tags' =>  [
                    0 => 'other',
                ],
                'color' => '#FFFFFF',
            ...
            [
                'identifier' => 'abstract-105',
                'category' => 'other',
                'displayName' => 'Abstract 105',
            ...
            [
                'identifier' => 'airplane-departure',
                'category' => 'other',
                'displayName' => 'Airplane Departure',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M442.6 67.37c-1.6.01-3.2.06-4.8.16-13.2.73-26.9 3.8-36.8 8.74l-.2.12-281 120.21-4.1-2.6c-20.62-13.3-42.15-26.8-73.84-32.1 2.07 4.7 4.64 9.9 7.76 15.5 6.69 11.9 15.26 25.3 23.75 37.6 8.49 12.2 16.96 23.3 23.21 30.4 2.41 2.8 4.02 4.3 5.42 5.6l172.2-68.6-1.2 14.4c-3.7 44.4-11.3 89.6-23.5 135.7l28.5-19c32.6-51.5 43.5-87.2 71-157.3l1.2-3 91.5-50.5h.2c22.9-11.49 32.8-21.65 34.4-25.36.8-1.86.6-1.37.2-2.04-.4-.66-2.3-2.39-5.8-3.85-5.4-2.2-13.8-3.72-23.3-4.03-1.5-.05-3.2-.07-4.8-.05zm-283 11.74l-22.1 4.4L222 133.3l60.1-25.7C248 96.96 210.8 86.98 159.6 79.11zM32 439v18h448v-18H32z"/></svg>',
                'tags' =>  [
                    0 => 'other',
                ],
                'color' => '#FFFFFF',
            ...
            [
                ...
                'category' => 'other',
                'displayName' => 'Algeria',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M418.4 23.98c-87.5-7.58-164.6 2.58-228 35.99l11.3 83.23-181.56 71.3-5.99 43.4L294.5 490.4l57-2.2 146.4-114c-60.4-73.4-22.3-118.9-45.6-161.2-48-86.8-45.2-133.74-33.9-189.02z"/></svg>',
                'tags' =>  [
                    0 => 'other',
                ],
                'color' => '#FFFFFF',
            ...
            [
                'identifier' => 'amber-mosquito',
                'category' => 'other',
                'displayName' => 'Amber Mosquito',
            ...
            [
                'identifier' => 'american-football-player',
                'category' => 'other',
                'displayName' => 'American Football Player',
            ...
            [
                'identifier' => 'ample-dress',
                'category' => 'other',
                'displayName' => 'Ample Dress',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M288 16l32 16s-25.2 44.02-16 64c5 10.8 32 16 32 16-16 32-32 80-32 96 80 48 80 144 160 176 0 64-80 112-208 112S48 448 48 384c80-32 80-128 160-176 0-16-16-64-32-96 0 0 27-5.2 32-16 9.2-19.98-16-64-16-64l32-16c0 32 16 48 32 48s32-16 32-48z"/></svg>',
                'tags' =>  [
                    0 => 'other',
                ],
                'color' => '#FFFFFF',
            ...
            [
                'identifier' => 'ancient-columns',
                'category' => 'other',
                'displayName' => 'Ancient Columns',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M57 39v16h110V39H57zm32 34v318h46V73H89zm334 21.56l-46 23.04V391h46V94.56zM254.2 187L233 197.6V391h46V211.7L254.2 187zM73 409v30h78v-30H73zm144 0v30h78v-30h-78zm144 0v30h78v-30h-78zM38.49 457l-10 30H483.5l-10-30H38.49z"/></svg>',
                'tags' =>  [
                    0 => 'other',
                ],
                'color' => '#FFFFFF',
            ...
            [
                'identifier' => 'ancient-screw',
                'category' => 'other',
                'displayName' => 'Ancient Screw',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M27.91 27.78l11.61 46.46 48 16L119 216.2h128v-78h-77.5l-32.2-96.75zm456.19 0L374.7 41.45l-32.2 96.75H265v78h128l30.3-121.16 1.2-4.8 48-16zM213.6 74.22l-23 45.98h130.8l-23-45.98zm-39 159.98l3 5.9L311 292v-4.4l6.7-18-90.9-35.4zm102 0l47.4 18.4 6.9-18.4zm-87.1 29.9l11.5 23v10.1L311 340v-28.6zm11.5 52.5v28.6L311 388v-28.6zm0 48v28.7L311 436v-28.6zm0 48V443l110 41.2v-28.8z"/></svg>',
                'tags' =>  [
                    0 => 'other',
                ],
                'color' => '#FFFFFF',
            ...
            [
                ...
                'category' => 'other',
                'displayName' => 'Angola',
                'svg' => '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><path fill="currentColor" d="M82.42 23.22L51.69 46.46l13.49 25.49 32.23-34.49zM211.4 74.2L66.68 82.44l42.72 84.76-16.48 15.7 32.18 84-42.68 63-26.23 133.4 45.01-14.2 28.4 18 141-2.3 106.4 24 59.3-17.2-41.3-50.3V317.1l63-.7 2.3-66.7-55.5 1.5-18.8-126-71.9-10.5-12 34.5-56.3-3z"/></svg>',
                'tags' =>  [
                    0 => 'other',
                ],
                'color' => '#FFFFFF',
