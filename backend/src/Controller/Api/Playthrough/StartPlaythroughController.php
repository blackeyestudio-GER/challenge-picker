...
class StartPlaythroughController extends AbstractController
{
    ...
    #[Route('/api/playthroughs/{uuid}/start', name: 'api_playthrough_start', methods: ['PUT'])]
    public function __invoke(string $uuid): JsonResponse
    {
        ...
        try {
            $playthrough = $this->playthroughService->startPlaythrough($playthrough);
