...
#[IsGranted('ROLE_USER')]
class GetActiveRulesByUuidController extends AbstractController
{
    ...
    public function __invoke(): JsonResponse
    {
        try {
            ...
            // Find user's active playthrough (only one allowed per user)
            ...
            // Only return active rules when status is active
